...
public class CreationDefinitionsProcessusAvecRegles {
    ...
    public static DefinitionProcessus getProcessusErrone() {
        ...
        DefinitionTache eligibiliteEmprunteur = CreationDefinitionsTachesAvecRegles.getTacheEligibiliteEmprunteur(nomFichierReglesEmprunteur);
        processusErrone.ajoutePremiereTache(eligibiliteEmprunteur);

        // 3.   Ajouter vérification de propriété
        // 3.a.     Ajouter la tache
        DefinitionTache eligibilitePropriete = CreationDefinitionsTachesAvecRegles.getTacheEligibilitePropriete(nomFichierReglesPropriete);
        ...
        DefinitionTache eligibilitePret = CreationDefinitionsTachesAvecRegles.getTacheEligibilitePret(nomFichierReglesPret);
